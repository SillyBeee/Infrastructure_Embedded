...
void Pid_Init(Pid *pid, float Kp, float Ki, float Kd, float dt, Pid_Type type)
{
    ...
    pid->EnableFirstOrderFiltering = false;
    pid->FirstOrderFiltering_Coefficient = 0.0f;
...
{
    pid->EnableFirstOrderFiltering = EnableFirstOrderFiltering;
    pid->FirstOrderFiltering_Coefficient = FirstOrderFiltering_Coefficient;
}
