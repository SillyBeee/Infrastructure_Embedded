...
void DM4310::Deserialize_Status(const uint8_t* status_buffer)
{
    ...
    // std::cout<<"DM4310 Status: "<<std::endl;
    // std::cout<<"Position: "<<this->status.Position<<std::endl;
    // std::cout<<"Speed: "<<this->status.Speed<<std::endl;
    // std::cout<<"Torque: "<<this->status.Torque<<std::endl;
    // std::cout<<"Error Code: "<<(int)this->status.error_code<<std::endl;
    // std::cout<<"Temperature MOS: "<<this->status.Temperature_MOS<<std::endl;
    // std::cout<<"Temperature Rotor: "<<this->status.Temperature_Rotor<<std::endl;
}
...
void DM4310::Pid_Update(float target)
{
    ...
    {   
        ...
        MIT_Ctl_Msg_Send(0,0,0,0,this->pid_speed.Get_Output());
        std::cout<<"status.Speed: "<<this->status.Speed<<std::endl;
        std::cout<<"target: "<<target<<std::endl;
        std::cout<<"output: "<<this->pid_speed.Get_Output()<<std::endl;
    }
    else
    {
        DM_Error_Handler();
